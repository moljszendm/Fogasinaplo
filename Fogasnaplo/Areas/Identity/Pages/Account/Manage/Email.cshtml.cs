        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"A jóváhagyáshoz <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>kattints ide</a>.");

                StatusMessage = "A jóváhagyó kódot elküldtük az e-mail címedre.";
                return RedirectToPage();
            }

            StatusMessage = "Az e-mail cím módosítása SIKERTELEN!";
            return RedirectToPage();
        }
